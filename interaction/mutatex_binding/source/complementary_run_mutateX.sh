...
#SBATCH -D /home/projects/22117_protein_structure/projects/group07/22117_protein_structure_group7/interaction/mutatex_binding/complementary_mutateX_run

# Queuing system is currently not working, so we have to make sure to change directory at the beginning of the script
cd /home/projects/22117_protein_structure/projects/group07/22117_protein_structure_group7/interaction/mutatex_binding/complementary_mutateX_run
...
mutatex $structure \
	...
	-M ../mutate_runfile_template.txt -q ../complementary_poslist.txt \
